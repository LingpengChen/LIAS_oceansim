...
class Colorpicker_Scenario():
    ...
    def make_window(self):
        ...
        window = ui.Window("Render Result", width=1920/2, height=(1080 + 40)/2, visible=True)
        ...
        with window.frame:
            with ui.ZStack(height=1080):
                ...
                ui.Label('Run the scenario for image to be received',
                            ...
                            word_wrap=True)
                render_result = ui.ImageWithProvider(self.image_provider, width=1920/2, height=1080/2,
