...
class UIBuilder():
    ...
    def _on_init(self):
        ...
        # Robot parameters
        self._rob_mass = 10.0 # kg
        self._rob_angular_damping = 3.0
        self._rob_linear_damping = 3.0

        # Sensor
        self._sonar = None
        self._sonar_trans = np.array([0.3, -0.2, 0.0])
        self._cam = None
        self._cam_trans = np.array([0.3, -0.1, 0.0])
    ...
    def _setup_scene(self):
        ...
        if self._use_sonar:
            ...
            self._sonar = ImagingSonarSensor(prim_path=robot_prim_path + '/sonar',
                                            ...
                                            orientation=euler_angles_to_quat(np.array([0.0, 15.0, 0.0]),  degrees=True),
                                            hori_res=4000
                                            )
        ...
        if self._use_camera:
            ...
            # self._cam.set_focal_length(0.1 * self._cam_focal_length)    # self._cam_focal_length = 21
    ...
    def _reset_scenario(self):
        ...
        self._scenario.setup_scenario(self._rob, self._sonar, self._cam, self._DVL, self._baro, self._ctrl_mode, self._use_IMU)
